...
class TestMSOTData(unittest.TestCase):
    def test_msot_data(self):
        ...
        self.assertEqual(pa.get_scan_reconstructions().raw_data.shape, (20, 10, 333, 333, 1))
        self.assertEqual(pa.get_scan_unmixed().raw_data.shape, (20, 2, 111, 111, 1))
        self.assertEqual(pa.get_scan_so2().raw_data.shape, (20, 1, 111, 111, 1))
