...
def download_file(file_from, file_to):
    raise NotImplementedError(
        "No longer able to automatically download data."
...
def get_msot_time_series_example(image_type="so2"):
    ...
    data_sources = {
        "so2": "https://www.repository.cam.ac.uk/bitstream/handle/1810/345836/invivo_oe.hdf5",
        "icg": "https://www.repository.cam.ac.uk/bitstream/handle/1810/345836/invivo_dce.hdf5",
    }

    data_path = os.path.join(
        get_patato_data_folder(), f"{image_type}-timeseries-data.hdf5"
    )
...
def get_ithera_msot_time_series_example(image_type="so2"):
    ...
    data_sources = {
        "so2": "https://www.repository.cam.ac.uk/bitstream/handle/1810/345836/ithera_invivo_oe.zip",
...
def get_msot_phantom_example(image_type="clinical"):
    ...
    """
    data_sources = {
        "clinical": "https://www.repository.cam.ac.uk/bitstream/handle/1810/345836/clinical_phantom.hdf5",
