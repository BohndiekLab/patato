...
double fn_x(double x_0, double y_0, double c_0, double c_1, double x,
            double y) {
...
double fprime(double x_0, double y_0, double c_0, double c_1, double x,
  ...
  return -x_0 * x_0 / (c_0 * pow(x_0 * x_0 + y_0 * y_0, 1.5)) +
         ...
         pow(x_0 - x, 2.) /
             (c_1 * pow(pow(x_0 - x, 2.) + pow(y_0 - y, 2.), 1.5));
}
...
extern "C" __global__ void calculate_element(double *output, int *indices,
                                             int nx, int nt_pixel, double detx,
                                             double dety, double dl_couple,
                                             double dl_tissue, double x_0,
                                             double dx, double y_couple) {
  int pixel;
  int nt_offset;
  int i_x;
  int i_y;
