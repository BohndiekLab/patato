...
void calculate_element(py::array_t<double> output_py,
                       ...
                       double detx, double dety, double dl, double x_0,
                       double dx) {
...
//
// int main(){
//    // ~ 2 minutes to calculate all 256 detector elements. ~ halved by not
//    using Kahan sum.
//    // Looks like accuracy probably not affected. - Need to confirm.
//
//    // Note the way that I was doing it before (four separate terms then
//    adding), looks like it definitely did lose precision,
//    // but the Kahan summation here is unnecessary at double precision.
//    Consider adding some sort of pairwise adding if
...
//
//        threads.push_back(std::thread (calculate_element, output +
//        i*nx*nx*nt_pixel, indices + i*nx*nx*nt_pixel, nx, nt_pixel,
//                    detx, dety, dl, x_0, dx));
//    }
...
//    - start); std::cout << time.count() << " ms" << std::endl; return 0;
//}
